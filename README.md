...
| Possibility of EDIT and/or DELETE -depending what applies- only available to the owner of the item (place, profile, post, like) | As a USER I would like to have the possibility of editing and/or deleting the items I have created. | Using the currentUser context to check if the user is the owner of the item. | ![Edit and Delete](./README_Images/gifs/tests/edit_delete.gif) |
